...
//Img
import DiplomaAwardImg from '../../../img/awards/award-diploma-img.jpg';
//Scroll restore
    ...
    render() {
        return (
            <div className="container-wrapper">
                ...
                <Header/>
                <main>
                    <div className="l-awards pb-5">
                        <section className="container pt-5">

                            <h2 className="mt-5 section-title text-center h2-line">Awards</h2>
                            ...
                            <div className="row">
                                ...
                                <div className="col-6 text-center">
                                    <picture>
                                        <img src={DiplomaAwardImg} alt="award"/>
                                    </picture>
                                </div>
